...
--
-- Table structure for table `test col`
--

DROP TABLE IF EXISTS `test col`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
...
--
-- Dumping data for table `test col`
--

LOCK TABLES `test col` WRITE;
/*!40000 ALTER TABLE `test col` DISABLE KEYS */;
/*!40000 ALTER TABLE `test col` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2024-09-13 13:33:53
